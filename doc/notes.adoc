...
gioppler::test(std::string_view filter, std::string_view test_name, test);
gioppler::benchmark(std::string_view filter, std::string_view benchmark_name, benchmark);
...
gioppler::all::certify(bool condition);
gioppler::all::error(std::string_view message);
gioppler::all::error(StringFunction message_function);
gioppler::all::branch(std::string_view message);
gioppler::all::branch(StringFunction message_function);
gioppler::all::log(std::string_view message);
gioppler::all::log(StringFunction message_function);
