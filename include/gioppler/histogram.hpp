...
int main()
{
  ...
  std::normal_distribution<> d1{1000000, 10000};
  std::normal_distribution<> d2{2000000, 10000};
  std::normal_distribution<> d3{3000000, 10000};


  brainyguy::Histogram h6;
  for (int obs = 0; obs < 10; ++obs) {
    h6.add_observation(d1(gen));
    std::cout << h6.get_statistics() << std::endl;
  }


  brainyguy::Histogram h9;
  for (int obs = 0; obs < 20; ++obs) {
    h9.add_observation(d1(gen));
  }
  std::cout << h9.get_statistics() << std::endl;


  brainyguy::Histogram h8;
  for (int obs = 0; obs < 25; ++obs) {
    h8.add_observation(d1(gen));
  }
  std::cout << h8.get_statistics() << std::endl;


  brainyguy::Histogram h7;
  for (int obs = 0; obs < 50; ++obs) {
    h7.add_observation(d1(gen));
  }
  std::cout << h7.get_statistics() << std::endl;


  brainyguy::Histogram h5;
  for (int obs = 0; obs < 100; ++obs) {
    h5.add_observation(d1(gen));
  }
  std::cout << h5.get_statistics() << std::endl;


  brainyguy::Histogram h1;
  for (int obs = 0; obs < 1'000; ++obs) {
    h1.add_observation(d1(gen));
  }
  std::cout << h1.get_statistics() << std::endl;

  h1.add_observation(100);
  std::cout << h1.get_statistics() << std::endl;


  brainyguy::Histogram h3;
  for (int obs = 0; obs < 1'000; ++obs) {
    h3.add_observation(d1(gen));
    h3.add_observation(d2(gen));
  }
  std::cout << h3.get_statistics() << std::endl;


  brainyguy::Histogram h4;
  for (int obs = 0; obs < 1'000; ++obs) {
    h4.add_observation(d1(gen));
    h4.add_observation(d2(gen));
    h4.add_observation(d3(gen));
  }
  std::cout << h4.get_statistics() << std::endl;


  brainyguy::Histogram h2;
  h2.add_observation(1);
  h2.add_observation(2);
  h2.add_observation(3);
  std::cout << h2.get_statistics() << std::endl;

  h2.add_observation(4);
  h2.add_observation(5);
  h2.add_observation(6);
  std::cout << h2.get_statistics() << std::endl;

  h2.add_observation(7);
  h2.add_observation(8);
  std::cout << h2.get_statistics() << std::endl;

  h2.add_observation(9);
  std::cout << h2.get_statistics() << std::endl;

  h2.add_observation(10);
  std::cout << h2.get_statistics() << std::endl;

  h2.add_observation(11);
  std::cout << h2.get_statistics() << std::endl;
